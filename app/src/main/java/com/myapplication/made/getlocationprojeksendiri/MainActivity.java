...
//                    Toast.makeText(MainActivity.this, String.valueOf(location.getLatitude() + "\n" + location.getLongitude()), Toast.LENGTH_SHORT).show();
    ...
    public void viewLocation(View view) {
        if (lat != 0.0 && longi != 0.0) {
            ...
            Toast.makeText(this, "Klik tombol diatas dulu", Toast.LENGTH_SHORT).show();
        }
    }
}
